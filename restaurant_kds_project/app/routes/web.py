    ...
    orders_json = json.dumps([
        {
            ...
            "items": [{"product_name": i.item_name or (i.product.name if i.product else "?"), "quantity": i.quantity, "product_id": i.product_id, "category": (i.product.category if i.product else None)} for i in o.items],
        }
